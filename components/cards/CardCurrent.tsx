      ...
      <div className="bg-white box-background w-full flex flex-col justify-center rounded-3xl p-4 gap-6">
        ...
        <div className="w-[95%] flex justify-center">
          <div className="flex flex-col gap-3 w-[98%] ">
            ...
            <div className="bg-[#8833FF] w-full h-[0.5rem] rounded-full"></div>
        ...
        <div className="flex justify-between items-center">
          ...
          <div className="bg-[#DCDFF9] px-3 py-1 rounded-full text-[#7580E8] font-semibold">{days_left} days left</div>
        </div>
      </div>
    </div>
  );
